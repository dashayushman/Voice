...
def appendClfReportToListSvm(fileContent,clf_rpt, cm, acc_scr,best_params,itr,n_train,n_test,labels):
    ...
    #print(joinMatrix(cm, '\n','\t'))
    fileContent.append(tabulate(np.insert(cm, 0, labels, axis=1), labels, tablefmt="html"))

    fileContent.append('\n\n')
    fileContent.append('___________________________________________________________________________________')
    fileContent.append('\n\n')
    return fileContent

def appendClfReportToListNB(fileContent,clf_rpt, cm, acc_scr,algo,itr,n_train,n_test,labels):
...
def appendClfReportToListKnn(fileContent,clf_rpt, cm, acc_scr,n_neigh,itr,n_train,n_test,labels):
...
def appendClfReportToListHMM(fileContent,clf_rpt, cm, acc_scr,n_states,itr,n_train,n_test,labels):
...
def appendHeaderToFcListHMM(fileContent,accuracies,header):
    ...
    fileContent_h.append('_______________________________________________________________________________________________________')
    fileContent_h.append('\n\n')
