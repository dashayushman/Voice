...
def evaluate(n_folds,
             ...
             scaler=None):
    '''
        Method to run an evaluation of K nearest Neighbor Classifier on the training and validation data given the parameters required
        :param n_folds:             (int)                       : Number of folds for k-fold cross-validation
        :param n_neighbours:        (list)                      : List of number of neighbors to evaluate on
